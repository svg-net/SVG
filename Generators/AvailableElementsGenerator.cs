...
{{
    ...
    {{
        ...
        internal virtual void SetValue(string attributeName, ITypeDescriptorContext context, CultureInfo culture, object value)
        {{
            // TODO:
        }}
...
{{
    ...
    {{
        ...
        {{
            throw new NotImplementedException();
            // TODO: base.GetValue(attributeName);
        }}

        internal override void SetValue(string attributeName, ITypeDescriptorContext context, CultureInfo culture, object value)
        {{
