...
The rendering type plays a significant roll on rendering speeds. For example, if anti-aliasing is off for the SvgDocument render times are notably faster.
